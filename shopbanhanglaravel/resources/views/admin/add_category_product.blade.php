                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to('/save-category-product')}}" method="post">
                        ...
                        <div class="form-group">
                            <label @error('category_product_name') class="error" @enderror for="exampleInputEmail1">Tên danh mục</label>
                        ...
                        <div class="form-group">
                            <label @error('slug_category_product') class="error" @enderror for="exampleInputEmail1">Slug</label>
                        ...
                        <div class="form-group">
                            <label @error('category_product_desc') class="error" @enderror for="exampleInputPassword1">Mô tả danh mục</label>
                        ...
                        <div class="form-group">
                            <label @error('category_product_keywords') class="error" @enderror for="exampleInputPassword1">Từ khóa danh mục</label>
